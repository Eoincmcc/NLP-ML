...
if __name__ == '__main__':
    ...
    parser.add_argument('--qa_file', required=True, type=str, default="CORA-Analysis/CORA-main/data/xor_dev_full_v1_1.jsonl",
                        help="Question and answers file of the format: question \\t ['answer1','answer2', ...]")
    parser.add_argument('--ctx_file', required=True, type=str, default="CORA-Analysis/CORA-main/models/all_w100.tsv",
                        help="All passages file in the tsv format: id \\t passage_text \\t title")
    parser.add_argument('--encoded_ctx_file', type=str, default="/Users/johncmcc/Projects/NLP/CORA-Analysis/embeddings/wiki_emb_*",
    ...
    parser.add_argument('--out_file', type=str, default="xor_dev_dpr_retrieval_results.json",
